...
public class Visitas {
    ...
    public int getIdVisitador() { return idVisitador; }
    public void setIdVisitador(int idVisitador) { this.idVisitador = idVisitador; }
    public String getTipo_Prueba() { return Tipo_Prueba; }
    public void setTipo_Prueba(String Tipo_Prueba) { this.Tipo_Prueba = Tipo_Prueba; }
    ...
    public LocalDate getFechaeInforme() { return FechaeInforme; }
    public void setFechaeInforme(LocalDate FechaeInforme) { this.FechaeInforme = FechaeInforme; }
    public String getNovedadVisita() { return novedadVisita; }
    public void setNovedadVisita(String novedadVisita) { this.novedadVisita = novedadVisita; }
    public String getNombreVisitador() { return nombreVisitador; }
    public void setNombreVisitador(String nombreVisitador) { this.nombreVisitador = nombreVisitador; }
}